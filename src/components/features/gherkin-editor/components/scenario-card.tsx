...
// Add normalization helper at the top of the component
function normalizeScenario(scenario: any) {
  return {
    ...scenario,
    tags: Array.isArray(scenario.tags) ? scenario.tags : [],
    steps: Array.isArray(scenario.steps) ? scenario.steps : [],
    examples: scenario.examples && typeof scenario.examples === 'object' ? {
      ...scenario.examples,
      headers: Array.isArray(scenario.examples.headers) ? scenario.examples.headers : [],
      rows: Array.isArray(scenario.examples.rows) ? scenario.examples.rows : [],
    } : undefined,
  };
}
...
export function ScenarioCard({
    ...
    // Only useSortable ONCE for the root Card
    const {
        attributes,
        listeners,
        setNodeRef,
